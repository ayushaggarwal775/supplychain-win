    ...
    def post(self, request):
        ...
        def azure_deployment_function():       
            ...
            try:
                ...
                try:
                    databricksToken = vault_dict['parameters']['DataBricksToken']['value']
                    databricksScope = vault_dict['parameters']['DataBricksScope']['value']
                    databricksURL = vault_dict['parameters']['DataBricksWorkspaceURL']['value']
        ...
        # Thread for calling azure_deployment_function
        print('Before calling main thread')
        azure_thread = threading.Thread(target=azure_deployment_function)
        azure_thread.setDaemon = True
        azure_thread.start()
        print(azure_thread.daemon)
